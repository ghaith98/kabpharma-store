...
export default function ProfilePage() {
  ...
  /* ── class tokens — zero directional classes ── */
  ...
  const policyLinkClass =
    "group flex items-center justify-between gap-5 border-b border-[#edf0ed] py-5 transition last:border-b-0 hover:pl-2";
  ...
  return (
    ...
    >
      {/* ════════════════════════════════════════
          MOBILE
      ════════════════════════════════════════ */}
      <div dir="ltr" className="mx-auto max-w-md px-4 pb-10 pt-4 lg:hidden">

        {/* Hero card */}
        {user ? (
          <section className="relative overflow-hidden rounded-[1.5rem] bg-[#073f2c] p-5 text-white shadow-[0_14px_35px_rgba(7,63,44,0.15)]">
            <div className="absolute right-[-3rem] top-[-4rem] h-40 w-40 rounded-full bg-white/[0.05]" />
        ...
        >
          <Link href="/orders" className={mobileActionClass}>
            ...
            <FaChevronRight className="shrink-0 text-xs text-[#96a098] transition group-active:text-[#0a583b]" />
          </Link>
        ...
        <section className="mt-4 flex min-h-[76px] items-center justify-between gap-4 rounded-[1.25rem] border border-[#e2e7e3] bg-white px-4 py-3.5">
          ...
          <div className="flex rounded-full bg-[#f1f4f2] p-1">
            ...
            <button
              ...
              className={`flex h-9 min-w-12 items-center justify-center rounded-full px-3 text-xs font-extrabold transition ${
                lang === "ar" ? "bg-[#0a583b] text-white shadow-sm" : "text-[#647168]"
              }`}
            >
              AR
            </button>
        ...
        <section className="mt-4 overflow-hidden rounded-[1.25rem] border border-[#e2e7e3] bg-white">
          <button
            type="button"
            onClick={() => setPoliciesOpen((c) => !c)}
            aria-expanded={policiesOpen}
            aria-controls="mobile-profile-policies"
            className="flex min-h-[76px] w-full items-center justify-between gap-4 px-4 py-3.5 transition active:bg-[#f3f6f4]"
          >
            <div className="flex items-center gap-3.5">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#edf5f0] text-[#0a583b]">
                <FaFileContract />
          ...
          <div
            ...
            className={`grid transition-all duration-300 ease-in-out ${
              policiesOpen ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"
            }`}
          >
      ...
      {/* ════════════════════════════════════════
          DESKTOP
      ════════════════════════════════════════ */}
      <div dir="ltr" className="mx-auto hidden max-w-[1240px] px-4 pb-10 pt-8 sm:px-6 lg:block lg:px-8 lg:pt-12">
        <header className="mb-9">
          <div className="flex items-center gap-3">
            <span className="h-px w-8 bg-[#0a583b]" />
            <p className={`text-[11px] font-extrabold uppercase text-[#0a583b] ${
              isArabic ? "tracking-normal" : "tracking-[0.2em]"
            }`}>
              KAB Pharma
            </p>
          </div>
          <h1 className={`mt-4 text-[2.8rem] font-extrabold text-[#142019] ${
        ...
        <div className="overflow-hidden rounded-[1.75rem] border border-[#dde4df] bg-white shadow-[0_25px_80px_rgba(20,32,25,0.06)]">
          <div dir="ltr" className="grid grid-cols-[310px_minmax(0,1fr)]">
            ...
            <aside className="relative overflow-hidden bg-[#073f2c] text-white">
              ...
              <div className="relative flex min-h-[680px] h-full flex-col p-8">
                <p className={`text-[10px] font-extrabold uppercase text-white/55 ${
                  isArabic ? "tracking-normal" : "tracking-[0.2em]"
                }`}>
                ...
                <div className="mt-10">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-white/10 text-2xl font-extrabold uppercase backdrop-blur">
                ...
                >
                  <Link href="/orders" className={sidebarLinkClass}>
                    ...
                    <FaChevronRight className="text-[11px] text-white/35 transition group-hover:text-white" />
                  </Link>
            ...
            <div className="min-w-0 p-12 xl:p-14">
              {user ? (
                <section>
                  ...
                  <Link href="/contact" className={`${accountLinkClass} border-b`}>
                    <div className="flex min-w-0 items-center gap-5">
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-[#dbe5de] bg-[#f3f7f4] text-[#0a583b]">
                        <FaHeadset />
                      </div>
                ...
                <section className="border border-[#e3e6df] bg-[#f5f3ed] p-8">
                  <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
                    <div className="max-w-xl">
                      <p className={`text-[10px] font-extrabold uppercase text-[#0a583b] ${
                      ...
                      <h3 className="mt-3 text-2xl font-extrabold text-[#142019]">
                        {isArabic ? "تجربة تسوق أسهل" : "A better shopping experience"}
                      </h3>
                      <div className="mt-6 grid gap-4 sm:grid-cols-3">
                        <div className="border-t border-[#d8ddd5] pt-3">
                          <span className="text-xs font-extrabold text-[#0a583b]">01</span>
                          <p className="mt-2 text-sm font-bold text-[#526057]">
                            {isArabic ? "متابعة الطلبات" : "Track orders"}
                          </p>
                        </div>
                        <div className="border-t border-[#d8ddd5] pt-3">
                          <span className="text-xs font-extrabold text-[#0a583b]">02</span>
                          <p className="mt-2 text-sm font-bold text-[#526057]">
                            {isArabic ? "حفظ البيانات" : "Save details"}
                          </p>
                        </div>
                        <div className="border-t border-[#d8ddd5] pt-3">
                          <span className="text-xs font-extrabold text-[#0a583b]">03</span>
                          <p className="mt-2 text-sm font-bold text-[#526057]">
              ...
              <section className="mt-11 sm:mt-14">
                ...
                <button
                  ...
                  className="group mt-6 flex w-full items-center justify-between gap-5 border-y border-[#dfe5e1] py-5"
                >
                  <div>
                  ...
                  <div className="overflow-hidden">
                    ...
                    >
                      <Link href="/privacy-policy" className={policyLinkClass}>
                        ...
                        <FaChevronRight className="shrink-0 text-xs text-[#99a29c] transition group-hover:text-[#0a583b]" />
                      </Link>
