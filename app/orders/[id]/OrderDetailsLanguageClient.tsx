...
export default function OrderDetailsLanguageClient({
  ...
  const currentStepIndex =
    currentTimelineSteps.findIndex(
      (step) =>
        step.key ===
        order.status
    );
        ...
        <div className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          {!isRejected ? (
            <div className="mb-8">
              ...
              {currentTimelineSteps.length >
              0 ? (
                <div className="space-y-5">
                  {currentTimelineSteps.map(
                    (
                      step,
                      index
                    ) => {
                ...
                <p className="text-sm text-gray-500">
                  {lang === "ar"
                    ...
                    : "Order timeline details are currently unavailable."}
                </p>
              )}
            </div>
          ) : (
