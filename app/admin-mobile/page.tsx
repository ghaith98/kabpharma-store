  ...
  export default function AdminMobilePage() {
    ...
    { href: "/admin/delivery-orders/manage?mobile=1", title: "Orders", icon: "📦" },
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-green-50 px-4 py-6">
        <div className="mx-auto max-w-md">
          <section className="mb-5 rounded-[2rem] bg-green-700 p-6 text-white shadow">
            ...
            <p className="mt-2 text-sm text-green-50">
              Delivery, drivers, shop orders and settings.
            </p>
          </section>
