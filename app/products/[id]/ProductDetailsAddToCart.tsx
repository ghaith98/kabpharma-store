  ...
  return (
    <>
      <div className="mt-6 border-t border-[#dedfdd] pt-5">
        ...
        <div className="mt-4 hidden items-stretch gap-2 sm:gap-3 md:flex">
          <div className="flex h-[52px] w-[126px] shrink-0 items-center border border-[#bfc7c1] bg-white">
            <button
              type="button"
              onClick={() =>
                setQuantity((current) =>
              ...
              className="flex h-full w-10 items-center justify-center text-[#526057] transition hover:bg-[#edf5f0] hover:text-[#0a583b] disabled:cursor-not-allowed disabled:opacity-40"
            >
              <Minus size={16} />
            </button>

            <span className="flex h-full min-w-11 flex-1 items-center justify-center border-x border-[#dfe4e0] text-center text-sm font-semibold text-[#142019]">
              {quantity}
            </span>
          ...
          <button
            ...
            onClick={handleAdd}
            disabled={disabled}
            className="flex min-h-[52px] min-w-0 flex-1 items-center justify-center gap-2 rounded-none border border-[#0a583b] bg-[#0a583b] px-3 text-xs font-semibold text-white transition hover:bg-[#073f2c] disabled:cursor-not-allowed disabled:border-[#dfe3df] disabled:bg-[#f4f5f4] disabled:text-[#9aa19c] sm:gap-3 sm:px-6 sm:text-sm"
          >
            <ShoppingBag size={18} />
