          ...
          <SwiperSlide key={item.id} className="h-auto">
            ...
            >
              ...
              >
                ...
                <div
                  dir={isArabic ? "rtl" : "ltr"}
                  className="absolute left-3 top-3 flex flex-col items-start gap-2"
                >
                  {isOutOfStock ? (
              ...
              >
                ...
                {description && (
                  <p className="mt-1 line-clamp-1 text-xs leading-5 text-[#647168]">
                    {description}
                  </p>
                )}
                ...
                <div className="mt-auto flex items-end justify-between gap-3 pt-4">
                  <div className="min-w-0">
                    ...
                    {salePercent > 0 && (
                      <p className="mt-1 whitespace-nowrap text-[11px] font-bold text-[#99a29c] line-through">
                  ...
                  <Link
                    ...
                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#edf5f0] text-[#0a583b] transition hover:bg-[#0a583b] hover:text-white"
                  >
                    {isArabic ? (
                      <FiArrowLeft />
                    ) : (
