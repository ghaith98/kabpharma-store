  ...
  export default function ReviewsSection({
    ...
    async function handleSubmit(e: React.FormEvent) {
      ...
      if (showName && !user?.full_name && !manualName.trim()) {
        alert(
    lang === "ar"
      ? "يرجى إدخال الاسم أو إلغاء إظهار الاسم."
      : "Please enter your name or uncheck Show my name."
  );
        return;
      }
  ...
  : "Be the first to review this product"}
            ...
            <p className="mt-2 text-sm text-gray-600">
              {lang === "ar"
  ? "شارك تجربتك مع العملاء الآخرين."
                ...
                <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-xs font-semibold text-gray-500">
                      {lang === "ar" ? "عميل موثّق" : "Verified customer"}
                    </p>
                  </div>
          ...
          <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/40 px-4">
            <div className="w-full max-w-lg rounded-[2rem] bg-white p-6 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <p className="mb-3 font-bold text-gray-900">{lang === "ar" ? "تقييمك" : "Your Rating"}</p>
                ...
                <label className="flex cursor-pointer items-center gap-3 text-sm font-bold text-gray-700">
                  <input
                    ...
                    className="h-4 w-4"
                  />
                  {lang === "ar" ? "إظهار اسمي بشكل علني" : "Show my name publicly"}
                </label>
