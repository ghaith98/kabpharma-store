...
const text = `${productName} ${productDescription} ${
              ...
              {showCategories && (
                <div className="border-b border-gray-200 pb-6">
                  <h3 className="mb-4 text-xl font-bold text-gray-900">
                    {lang === "ar" ? "تصنيفات المنتجات" : "Product categories"}
                  </h3>
  ...
  : category.name_en || category.name}
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex cursor-pointer items-center gap-3 text-sm font-bold text-gray-800">
                      <input
                        ...
                        className="h-4 w-4"
                      />
                      {lang === "ar" ? "عليه خصم" : "On sale"}  
                    </label>
                  </div>
                </div>

                <div className="border-b border-gray-200 py-6">
                  <h3 className="mb-4 text-xl font-bold text-gray-900">{lang === "ar" ? "السعر" : "Price"}</h3>
                ...
                <div className="py-6">
                  <h3 className="mb-4 text-xl font-bold text-gray-900">{lang === "ar" ? "ترتيب حسب" : "Sort by"}</h3>
...
<option value="price_high">{lang === "ar" ? "السعر: من الأعلى للأقل" : "Price: High to Low"}</option>
          ...
          {filteredProducts.length === 0 ? (
            <div className="relative z-10 mx-auto max-w-xl rounded-2xl bg-white p-10 text-center shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900">{lang === "ar" ? "لم يتم العثور على منتجات" : "No products found"}</h2>
              <p className="mt-3 text-gray-600">
                {lang === "ar"
  ? "جرّبي تغيير الفلاتر أو البحث عن منتج آخر."
