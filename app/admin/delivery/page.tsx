        ...
        <section className="mb-8 rounded-2xl bg-white p-6 shadow">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <input
              ...
              className="w-full rounded-xl border p-3 text-black sm:w-64"
            />

            <button
              onClick={saveFreeShippingThreshold}
              disabled={savingThreshold}
              className="rounded-xl bg-green-600 px-5 py-3 font-semibold text-white disabled:bg-gray-400"
            >
        ...
        <section className="mb-8 rounded-2xl bg-white p-6 shadow">
          ...
          <form onSubmit={addArea} className="grid gap-3 sm:grid-cols-4">
            ...
            <button
              ...
              className="rounded-xl bg-black px-5 py-3 font-semibold text-white disabled:bg-gray-400"
            >
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Fee:{" "}
                        {Number(area.delivery_fee).toLocaleString()} SYP
                      </p>

                      <p
                        className={`mt-1 text-sm font-bold ${
                          area.is_active ? "text-green-700" : "text-red-600"
                        }`}
                      >
