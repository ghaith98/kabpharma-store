    ...
    <main dir="rtl" className="min-h-screen bg-gradient-to-b from-gray-50 to-green-50 p-4">
      <div className="mx-auto max-w-md">
        ...
        <div className="mb-5 flex gap-2">
          <a href="/driver" className="flex-1 rounded-xl bg-gray-900 py-3 text-center text-sm font-bold text-white">
            الطلبات المتاحة
          </a>
        </div>
        ...
        <div className="space-y-4">
          {orders.length === 0 ? (
            <div className="rounded-2xl bg-white p-6 text-center shadow">
              ...
              <a href="/driver" className="mt-4 inline-block rounded-xl bg-green-600 px-5 py-3 text-sm font-bold text-white">
                عرض الطلبات المتاحة
              </a>
            </div>
          ) : (
